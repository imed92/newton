...
class App_KernelTestDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\Api\\ApiGenresController' => 'getApiGenresControllerService',
            'App\\Controller\\Api\\ApiMovieController' => 'getApiMovieControllerService',
            'App\\Controller\\Back\\CastingController' => 'getCastingControllerService',
            'App\\Controller\\Back\\MovieController' => 'getMovieControllerService',
            'App\\Controller\\Back\\UserController' => 'getUserControllerService',
            'App\\Controller\\Front\\FavoritesController' => 'getFavoritesControllerService',
            'App\\Controller\\Front\\LoginController' => 'getLoginControllerService',
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once \dirname(__DIR__, 4).'/src/EventSubscriber/MaintenanceSubscriber.php';
            include_once \dirname(__DIR__, 4).'/src/EventSubscriber/RandomMovieSubscriber.php';
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('kernel.response', [0 => function () {
            return ($this->privates['App\\EventSubscriber\\MaintenanceSubscriber'] ?? ($this->privates['App\\EventSubscriber\\MaintenanceSubscriber'] = new \App\EventSubscriber\MaintenanceSubscriber($this->getEnv('bool:IS_MAINTENANCE'))));
        }, 1 => 'onKernelResponse'], 0);
        $instance->addListener('kernel.controller', [0 => function () {
            return ($this->privates['App\\EventSubscriber\\RandomMovieSubscriber'] ?? $this->getRandomMovieSubscriberService());
        }, 1 => 'onKernelController'], 0);
        $instance->addListener('kernel.response', [0 => function () {
    ...
    /**
     * Gets the private '.service_locator.uw9xvWR' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_Uw9xvWRService()
    {
        return $this->privates['.service_locator.uw9xvWR'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'security.firewall.map.context.api_secure' => ['privates', 'security.firewall.map.context.api_secure', 'getSecurity_Firewall_Map_Context_ApiSecureService', true],
    ...
    {
        return $this->privates['App\\EventSubscriber\\MaintenanceSubscriber'] = new \App\EventSubscriber\MaintenanceSubscriber($this->getEnv('bool:IS_MAINTENANCE'));
    }

    /**
     * Gets the private 'App\EventSubscriber\RandomMovieSubscriber' shared autowired service.
     *
     * @return \App\EventSubscriber\RandomMovieSubscriber
     */
    protected function getRandomMovieSubscriberService()
    {
        return $this->privates['App\\EventSubscriber\\RandomMovieSubscriber'] = new \App\EventSubscriber\RandomMovieSubscriber(($this->privates['App\\Repository\\MovieRepository'] ?? $this->getMovieRepositoryService()), ($this->services['.container.private.twig'] ?? $this->get_Container_Private_TwigService()));
    }
    ...
    {
        return $this->privates['cache.annotations.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('OD6m5Npe6u', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        $this->privates['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('kfhkGWfM4C', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true))));
    ...
    {
        return $this->privates['cache.property_info.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('zbChzQjx8M', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.security_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('969T144WQN', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Keq6U+dvHP', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('-g0hI2Ea7R', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('-ZcT3Pd83+', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.validator_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('JRnquMZfU8', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getDoctrine_Orm_ContainerRepositoryFactoryService()
    {
        return $this->privates['doctrine.orm.container_repository_factory'] = new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\CastingRepository' => ['privates', 'App\\Repository\\CastingRepository', 'getCastingRepositoryService', true],
    ...
    {
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(($this->privates['.service_locator.uw9xvWR'] ?? $this->get_ServiceLocator_Uw9xvWRService()), new RewindableGenerator(function () {
            ...
            yield 'security.firewall.map.context.api_secure' => ($this->privates['.security.request_matcher.TKYa7ds'] ?? ($this->privates['.security.request_matcher.TKYa7ds'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/secure')));
            yield 'security.firewall.map.context.api_public' => ($this->privates['.security.request_matcher.p4VlLPC'] ?? ($this->privates['.security.request_matcher.p4VlLPC'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api')));
    ...
    private $loadedDynamicParameters = [
        ...
        'app.favorites_empty_enabled' => false,
        'app.omdb_api_key' => false,
    ...
    private function getDynamicParameter(string $name)
    {
        switch ($name) {
            ...
            case 'app.favorites_empty_enabled': $value = $this->getEnv('bool:FAVORITES_EMPTY_ENABLED'); break;
            case 'app.omdb_api_key': $value = $this->getEnv('OMDB_API_KEY'); break;
            case 'app.is_maintenance': $value = $this->getEnv('bool:IS_MAINTENANCE'); break;
