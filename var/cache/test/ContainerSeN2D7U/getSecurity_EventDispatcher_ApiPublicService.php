 ...
 */
class getSecurity_EventDispatcher_ApiPublicService extends App_KernelTestDebugContainer
{
    /**
    ...
    {
        $container->privates['security.event_dispatcher.api_public'] = $instance = new \Symfony\Component\EventDispatcher\EventDispatcher();

        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\CheckPassportEvent', [0 => function () use ($container) {
            return ($container->privates['security.listener.user_checker.api_public'] ?? $container->load('getSecurity_Listener_UserChecker_ApiPublicService'));
