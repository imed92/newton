 ...
 */
class getSecurity_EventDispatcher_ApiSecureService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'security.event_dispatcher.api_secure' shared service.
     *
     * @return \Symfony\Component\EventDispatcher\EventDispatcher
     */
    public static function do($container, $lazyLoad = true)
    {
        $container->privates['security.event_dispatcher.api_secure'] = $instance = new \Symfony\Component\EventDispatcher\EventDispatcher();

        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\CheckPassportEvent', [0 => function () use ($container) {
            return ($container->privates['security.listener.user_checker.api_secure'] ?? $container->load('getSecurity_Listener_UserChecker_ApiSecureService'));
