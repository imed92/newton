...
class getTest_PrivateServicesLocatorService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        return $container->services['test.private_services_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'App\\Command\\MoviesPosterCommand' => ['privates', 'App\\Command\\MoviesPosterCommand', 'getMoviesPosterCommandService', true],
            'App\\Command\\MoviesSlugifyCommand' => ['privates', 'App\\Command\\MoviesSlugifyCommand', 'getMoviesSlugifyCommandService', true],
            'App\\DataFixtures\\AppFixtures' => ['privates', 'App\\DataFixtures\\AppFixtures', 'getAppFixturesService', true],
            'App\\EventSubscriber\\MaintenanceSubscriber' => ['privates', 'App\\EventSubscriber\\MaintenanceSubscriber', 'getMaintenanceSubscriberService', false],
            'App\\EventSubscriber\\RandomMovieSubscriber' => ['privates', 'App\\EventSubscriber\\RandomMovieSubscriber', 'getRandomMovieSubscriberService', false],
            'App\\Form\\CastingType' => ['privates', 'App\\Form\\CastingType', 'getCastingTypeService', true],
            ...
            'App\\Service\\FavoritesManager' => ['privates', 'App\\Service\\FavoritesManager', 'getFavoritesManagerService', true],
            'App\\Service\\MySlugger' => ['privates', 'App\\Service\\MySlugger', 'getMySluggerService', true],
            'App\\Service\\OmdbApi' => ['privates', 'App\\Service\\OmdbApi', 'getOmdbApiService', true],
            ...
            'security.firewall.map.config.api_secure' => ['privates', 'security.firewall.map.config.api_secure', 'getSecurity_Firewall_Map_Config_ApiSecureService', true],
            ...
            'security.authenticator.jwt.api_secure' => ['privates', 'security.authenticator.jwt.api_secure', 'getSecurity_Authenticator_Jwt_ApiSecureService', true],
            'security.authenticator.manager.api_secure' => ['privates', 'security.authenticator.manager.api_secure', 'getSecurity_Authenticator_Manager_ApiSecureService', true],
            'debug.security.firewall.authenticator.api_secure' => ['privates', 'debug.security.firewall.authenticator.api_secure', 'getDebug_Security_Firewall_Authenticator_ApiSecureService', true],
            'security.listener.user_checker.api_secure' => ['privates', 'security.listener.user_checker.api_secure', 'getSecurity_Listener_UserChecker_ApiSecureService', true],
            'security.exception_listener.api_secure' => ['privates', 'security.exception_listener.api_secure', 'getSecurity_ExceptionListener_ApiSecureService', true],
            ...
            'security.firewall.map.config.api_public' => ['privates', 'security.firewall.map.config.api_public', 'getSecurity_Firewall_Map_Config_ApiPublicService', true],
            ...
            'security.authenticator.manager.api_public' => ['privates', 'security.authenticator.manager.api_public', 'getSecurity_Authenticator_Manager_ApiPublicService', true],
            'debug.security.firewall.authenticator.api_public' => ['privates', 'debug.security.firewall.authenticator.api_public', 'getDebug_Security_Firewall_Authenticator_ApiPublicService', true],
            'security.listener.user_checker.api_public' => ['privates', 'security.listener.user_checker.api_public', 'getSecurity_Listener_UserChecker_ApiPublicService', true],
            'security.exception_listener.api_public' => ['privates', 'security.exception_listener.api_public', 'getSecurity_ExceptionListener_ApiPublicService', true],
            ...
            'debug.security.firewall.authenticator.api_secure.inner' => ['privates', 'debug.security.firewall.authenticator.api_secure.inner', 'getDebug_Security_Firewall_Authenticator_ApiSecure_InnerService', true],
            'debug.security.firewall.authenticator.api_public.inner' => ['privates', 'debug.security.firewall.authenticator.api_public.inner', 'getDebug_Security_Firewall_Authenticator_ApiPublic_InnerService', true],
            ...
            'security.user_checker.api_secure' => ['privates', 'security.user_checker', 'getSecurity_UserCheckerService', true],
            'security.user_checker.api_public' => ['privates', 'security.user_checker', 'getSecurity_UserCheckerService', true],
            ...
            'security.firewall.context_locator' => ['privates', '.service_locator.uw9xvWR', 'get_ServiceLocator_Uw9xvWRService', false],
            ...
            'argument_resolver.controller_locator' => ['privates', '.service_locator.pW8ZGOu', 'get_ServiceLocator_PW8ZGOuService', true],
            ...
            'security.firewall.authenticator.api_secure' => ['privates', 'debug.security.firewall.authenticator.api_secure', 'getDebug_Security_Firewall_Authenticator_ApiSecureService', true],
            'security.firewall.authenticator.api_public' => ['privates', 'debug.security.firewall.authenticator.api_public', 'getDebug_Security_Firewall_Authenticator_ApiPublicService', true],
            ...
            'App\\Command\\MoviesPosterCommand' => '?',
            'App\\Command\\MoviesSlugifyCommand' => '?',
            'App\\DataFixtures\\AppFixtures' => '?',
            'App\\EventSubscriber\\MaintenanceSubscriber' => '?',
            'App\\EventSubscriber\\RandomMovieSubscriber' => '?',
            'App\\Form\\CastingType' => '?',
            'App\\Form\\MovieType' => '?',
            'App\\Form\\ReviewType' => '?',
            'App\\Form\\UserType' => '?',
            ...
            'security.firewall.map.config.api_secure' => '?',
            'security.event_dispatcher.api_secure' => '?',
            'security.authenticator.jwt.api_secure' => '?',
            'security.authenticator.manager.api_secure' => '?',
            'debug.security.firewall.authenticator.api_secure' => '?',
            'security.listener.user_checker.api_secure' => '?',
            'security.exception_listener.api_secure' => '?',
            'security.firewall.map.context.api_secure' => '?',
            'security.firewall.map.config.api_public' => '?',
            'security.event_dispatcher.api_public' => '?',
            'security.authenticator.manager.api_public' => '?',
            'debug.security.firewall.authenticator.api_public' => '?',
            'security.listener.user_checker.api_public' => '?',
            'security.exception_listener.api_public' => '?',
            ...
            'debug.security.firewall.authenticator.api_secure.inner' => '?',
            'debug.security.firewall.authenticator.api_public.inner' => '?',
            ...
            'security.user_checker.api_secure' => '?',
            'security.user_checker.api_public' => '?',
            ...
            'security.firewall.authenticator.api_secure' => '?',
            'security.firewall.authenticator.api_public' => '?',
